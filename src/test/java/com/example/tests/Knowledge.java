...
public class Knowledge extends BaseTest
{
    ...
    public void navigateToKnowledgeList() throws InterruptedException 
    {
    	...
    	test.info("Open Knowledge list from All menu");
		...
		Thread.sleep(2000);
    	test.info("Clicking on the Standard Template option");
    ...
    @Test(description = "Verification of Knowledge Article", dependsOnMethods = "navigateToChangeList")
    public void SubmitingKnowledge() throws InterruptedException 
    {
    	...
    	test.info("Verification of Submit button when mandatory fields are Empty");
    	...
    	test.info("Verification of Error massage without fill mandatory fields");
    	...
    	Thread.sleep(1000);
    	//Click on Submit button
    	test.info("Verification of Submit button");
    ...
    {
    	test = ExtentReportManager.createTest("Opening Knowledge record after Submition"); 
        ...
        test.info("Verification of Knowledge record on table");
     ...
     // Open Knowledge
      ...
      //Verification of State 
    	...
    	String state=driver.findElement(By.xpath("//*[@id='sys_readonly.kb_knowledge.workflow_state']/option[text()='Draft']")).getText();
        ...
        test.pass("Knowledge record Published");
...
{      
 ...
 // Open Knowledge
    ...
    for (WebElement ele2 : openKNw) 
    {
        ...
        Thread.sleep(1000);
        test.info("Verification of State");
    	String state=driver.findElement(By.xpath("//*[@id='sys_readonly.kb_knowledge.workflow_state']/option[text()='Published']")).getText();
    	System.out.println("State is:"+state);
        ...
        Thread.sleep(2000);
        test.info("Verification of Massage after click on Yes option for Help full");
      ...
      //Click on Retire UI Action
        ...
        test.pass("Knowledge record Retire");
        Reporter.getCurrentTestResult().setAttribute("TestData", knowledgeNo);
...
{      
 ...
 // Open Knowledge
    ...
    for (WebElement ele2 : openKNw) 
    {
        ...
        Thread.sleep(1000);
        test.info("Verification of State");
    	String state=driver.findElement(By.xpath("//*[@id='sys_readonly.kb_knowledge.workflow_state']/option[text()='Retired']")).getText();
    	System.out.println("State is:"+state);
