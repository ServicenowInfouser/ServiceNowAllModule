...
public class RequestRITMTask extends BaseTest {
    ...
    public String createRequest(ExtentTest test) throws InterruptedException {
        // Navigate to Employee Center
            ...
            // Search Catalog Item
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"homepage-search\"]/div/div/form/div/input")))
                .sendKeys("Big Data Analysis");
            driver.findElement(By.xpath("//*[@id=\"homepage-search\"]/div/div/form/div/span/button")).click();

            // Open catalog form
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mark[normalize-space()='Big Data Analysis']"))).click();
            ...
            WebElement fields = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'Indicates required')]")));
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[normalize-space()='" + (String) requestData[0][0] + "']"))).click();
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"sc_cat_checkout\"]/div[3]/div/div/button[2]/span[1]"))).click();

            // Capture Request Number
            requestno = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[@id=\"x6fb0f4029f8332002528d4b4232e70f6\"]/div[2]/div[2]/div/div[2]/b"))).getText();
    ...
    public String checkReqRITM(ExtentTest test, String requestno) throws InterruptedException {
        ...
        WebElement globalSearchBox = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//input[@class='form-control' and @type='search']")));
        ...
        List<WebElement> openReq = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
            By.xpath("//table[@id='sc_request_table']/tbody/tr/td[3]/a")));
        ...
        List<WebElement> openRITM = driver.findElements(
            By.xpath("//table[@id='sc_request.sc_req_item.request_table']/tbody/tr/td[3]/a"));
    ...
    public String checkCatalogTask(ExtentTest test, String requestno) throws InterruptedException {
        ...
        List<WebElement> openReq1 = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
            By.xpath("//table[@id='sc_request_table']/tbody/tr/td[3]/a")));
        ...
        List<WebElement> openRitmAfterApproval = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
            By.xpath("//table[@id='sc_request.sc_req_item.request_table']/tbody/tr/td[3]/a")));
